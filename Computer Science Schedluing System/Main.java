*
    ...
    Build: Core v1.6
    Description:
        Project is about implementing a scheduling system of lectures/Labs offered at the Computer Science Department  at UCF (CSD),
        ...
        while(option!=7){
            ...
            while(true){
                        try{
                            ...
                            option = Integer.parseInt(stringIntTemp);
                            break;
